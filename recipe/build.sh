...
export TF_SYSTEM_LIBS="boringssl,com_google_absl,com_github_googlecloudplatform_google_cloud_cpp,com_google_protobuf,com_github_grpc_grpc,flatbuffers,zlib"
